...
public class MulticastReceiver extends Thread {
    ...
    public MulticastReceiver(MulticastSocket socket, ProtocolHandler protocolHandler, InetAddress selfAddress) {
        this.socket = Objects.requireNonNull(socket, "Socket cannot be null");
        this.protocolHandler = Objects.requireNonNull(protocolHandler, "ProtocolHandler cannot be null");
